    ...
    <div className="space-y-4">
      ...
      <div className="mt-4">
        <VersionTabsApprovedOnly
          topicId={data.id}
          currentHref={`/supervisors/topics/all-topics-list/topics/${data.id}`}
...
export default function TopicListDetailPage() {
  ...
  return (
    <TopicDetailContent
      data={data}
      onBack={() => navigate("/supervisors/topics/all-topics-list")}
    />
  );
}
