...
import VersionTabsApprovedOnly from "../all-topics-list/VersionTabsApprovedOnly";
...
function TopicDetailContent({
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/70">Xem thông tin đề tài</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4">
        <VersionTabsApprovedOnly
          topicId={data.id}
          currentHref={`/supervisors/ai-check-duplicate/${data.id}`}
          onOpenVersion={(versionId) => {
            navigate(
              `/supervisors/topics/all-topics-list/topics/${data.id}/versions/${versionId}`,
              {
                state: {
...
export default function TopicListDetailDuplicatePage() {
  ...
  return (
    // <TopicDetailContent
    //   data={data}
    //   onBack={() => navigate("/supervisors/ai-check-duplicate")}
    // />
    <TopicDetailContent data={data} onBack={() => navigate(-1)} />
  );
}
